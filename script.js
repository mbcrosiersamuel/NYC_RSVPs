var DateTime = luxon.DateTime;
  ...
  {id:10, name:"4 Charles Prime Rib", restaurant_url:"https://nycprimerib.com/", area:"West Village", cuisine:"Steakhouse", platform:"Resy", platform_url:"https://resy.com/cities/ny/4-charles-prime-rib", available_at:"21 days in advance at 9 AM", days:21, time_3: DateTime.fromISO("1970-01-01T09:00:00", { zone: "America/New_York" })},
  {id:11, name:"Buvette", restaurant_url:"https://ilovebuvette.com/", area:"West Village", cuisine:"French", platform:"Resy", platform_url:"https://resy.com/cities/ny/buvette-nyc", available_at:"14 days in advance at 9 AM", days:14, time_3: DateTime.fromISO("1970-01-01T09:00:00", { zone: "America/New_York" })},
  {id:12, name:"Sadelle's", restaurant_url:"https://www.sadelles.com/", area:"Soho", cuisine:"Brunch", platform:"Resy", platform_url:"https://resy.com/cities/ny/sadelles?date=2023-02-01&seats=2", available_at:"30 days in advance at 10 AM", days:30,  time_3: DateTime.fromISO("1970-01-01T10:00:00", { zone: "America/New_York" })},
  ...
  {id:14, name:"I Sodi", restaurant_url:"https://www.isodinyc.com/", area:"West Village", cuisine:"Italian", platform:"Resy", platform_url:"https://resy.com/cities/ny/i-sodi", available_at:"14 days in advance at 12 AM", days:14, time_3: DateTime.fromISO("1970-01-01T00:00:00", { zone: "America/New_York" })},
  ...
  {id:16, name:"Shukette", restaurant_url:"https://www.shukettenyc.com/", area:"Chelsea", cuisine:"Middle Eastern", platform:"Resy", platform_url:"https://resy.com/cities/ny/shukette", available_at:"28 days in advance at 12 AM", days:28, time_3: DateTime.fromISO("1970-01-01T00:00:00", { zone: "America/New_York" })},
  {id:17, name:"Dhamaka", restaurant_url:"https://www.dhamaka.nyc/", area:"Lower East Side", cuisine:"Indian", platform:"Resy", platform_url:"https://resy.com/cities/ny/dhamaka", available_at:"28 days in advance at 12 AM", days:28, time_3: DateTime.fromISO("1970-01-01T00:00:00", { zone: "America/New_York" })},
  ...
  {id:19, name:"Llama San", restaurant_url:"https://www.llamasannyc.com/", area:"West Village", cuisine:"Peruvian", platform:"Resy", platform_url:"https://resy.com/cities/ny/llama-san", available_at:"28 days in advance at 9 AM", days:28, time_3: DateTime.fromISO("1970-01-01T09:00:00", { zone: "America/New_York" })},
  ...
  {id:22, name:"Masalawala & Sons", restaurant_url:"http://www.masalawala.com/", area:"Park Slope", cuisine:"Indian", platform:"Resy", platform_url:"https://resy.com/cities/ny/masalawala", available_at:"30 days in advance at 12 AM", days:30, time_3: DateTime.fromISO("1970-01-01T00:00:00", { zone: "America/New_York" })},
  ...
  {id:26, name:"Thai Diner", restaurant_url:"https://www.thaidiner.com/", area:"Nolita", cuisine:"Thai", platform:"Tock", platform_url:"https://www.exploretock.com/thaidiner", available_at:"6 days in advance at 12 AM", days:6, time_3: DateTime.fromISO("1970-01-01T00:00:00", { zone: "America/New_York" })},
  {id:27, name:"Rezdora", restaurant_url:"https://rezdora.nyc/", area:"Flatiron", cuisine:"Pasta", platform:"Resy", platform_url:"https://resy.com/cities/ny/rezdora", available_at:"21 days in advance at 12 AM", days:21, time_3: DateTime.fromISO("1970-01-01T00:00:00", { zone: "America/New_York" })},
  {id:28, name:"Don Angie", restaurant_url:"https://www.donangie.com/", area:"West Village", cuisine:"Italian", platform:"Resy", platform_url:"https://resy.com/cities/ny/don-angie", available_at:"7 days in advance at 9 AM", days:7, time_3: DateTime.fromISO("1970-01-01T09:00:00", { zone: "America/New_York" })},
  ...
  {id:31, name:"Cote", restaurant_url:"http://cotenyc.com/", area:"Chelsea", cuisine:"Korean", platform:"Resy", platform_url:"https://resy.com/cities/ny/cote", available_at:"30 days in advance at 10 AM", days:30, time_3: DateTime.fromISO("1970-01-01T10:00:00", { zone: "America/New_York" })},
  ...
  {id:34, name:"Minetta Tavern", restaurant_url:"http://www.minettatavernny.com/", area:"Soho", cuisine:"French", platform:"Resy", platform_url:"https://resy.com/cities/ny/minettatavern", available_at:"30 days in advance at 9 AM", days:30, time_3: DateTime.fromISO("1970-01-01T09:00:00", { zone: "America/New_York" })},
  {id:35, name:"Don Angie", restaurant_url:"http://www.donangie.com/", area:"West Village", cuisine:"Italian", platform:"Resy", platform_url:"https://resy.com/cities/ny/don-angie", available_at:"7 days in advance at 9 AM", days:7, time_3: DateTime.fromISO("1970-01-01T09:00:00", { zone: "America/New_York" })},
  {id:36, name:"Rezdôra", restaurant_url:"http://www.rezdora.nyc", area:"Flatiron", cuisine:"Italian", platform:"Resy", platform_url:"https://resy.com/cities/ny/rezdora", available_at:"21 days in advance at 6 AM", days:21, time_3: DateTime.fromISO("1970-01-01T06:00:00", { zone: "America/New_York" })},
  {id:36, name:"Misi", restaurant_url:"http://www.misinewyork.com", area:"Williamsburg", cuisine:"Italian", platform:"Resy", platform_url:"https://resy.com/cities/ny/misi", available_at:"30 days in advance at 10 AM", days:30, time_3: DateTime.fromISO("1970-01-01T10:00:00", { zone: "America/New_York" })}
  ...
  /*
  , minutes:  hours: data.time3.getHours()
   ...
   return newDate.toLocaleDateString('en-US'); */
    ...
    var table = new Tabulator("#restaurant-data", {
      ...
      columns:[ //Define Table Columns
       ...
       // {title:"Reservation Details", field:"available_at", sorter:"string", hozAlign:"center", width:"250", headerFilter:"input"},
      ...
      //  {title:"Time (EST)", field:"time_2", hozAlign:"center", sorter:"string", headerFilter:"input", headerFilterPlaceholder:"e.g. 9:00 AM"},
  /*{title: "Time (Formatted)", field: "time", sorter: "datetime", hozAlign: "center", formatter: "datetime", formatterParams: {
    outputFormat: "HH:mm A",
    timezone: "America/New_York",
}}, */
        {title:"Latest Open RSVP", field:"openres", sorter:"datetime", hozAlign:"center", width:"300", mutator:customMutator, headerFilter:"input", headerFilterPlaceholder:"e.g. 2/1/2024", formatter:"datetime", formatterParams:{
          outputFormat:"DDDD",
          invalidPlaceholder:"Invalid date",
}},
      ],
...
document.getElementById("submit").addEventListener("click", () => {
  ...
  if (today > bookingDate) {
    ...
    result.innerText = `>> Reservations for ${restaurantData.name} will open on ${bookingDate.toDateString()} at ${restaurantData.time_3.toFormat('HH:mm a ZZZZ')}`; 
